	...
	private function send_mail($to, $subject, $message, $html = false)
	{
		...
		*/
		...
		if ($html)
		{
		  ...
		  // Additional headers
		  $headers[] = 'From: Camagru Team <tmekwa@student.wethinkcode.co.za>';
		  $headers[] = 'Bcc: tmekwa@student.wethinkcode.co.za';
		}
		else
		{
		  $headers = 'From: Camagru Developer Team <tmekwa@student.wethinkcode.co.za>' .
		                "\r\n" .
